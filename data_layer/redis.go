...
func (r *RedisLayer) Init(ctx context.Context, conf *config.CacheConfig, prefix string) error {
	...
	r.keyPrefix = prefix
	return r.initScripts(ctx)
}

func (r *RedisLayer) initScripts(ctx context.Context) error {
	batchKeyExistScript := `
